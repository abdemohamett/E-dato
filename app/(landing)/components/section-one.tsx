    ...
    <div className='space-y-8'>
        ...
        <div  className='mx-6 md:flex text-center md:gap-4 md:max-w-5xl md:mx-auto'>
            <div className='text-start mb-10'>
                ...
                <p className='text-zinc-400 text-sm font-normal'>To record expense just click Add new and put the item name and the price/amount of the item</p>
            </div>
            <div id='#how-it-works' className='text-start mb-10'>
                ...
                <p className='text-zinc-400 text-sm font-normal'>Creating customers we made it easy as it never been just Add customer&apos;s name and phone number click create. DONE.</p>
            </div>
            <div className='text-start'>
                ...
                <p className='text-zinc-400 text-sm font-normal '>To record debt to an existing customer all you need todo is click the three dots then debts and add the debt to that customer</p>
            </div>
        </div>
         ...
         <div className='backdrop-blur-none md:m-[100px] md:border md:rounded-[20px] md:shadow-md border-gray-300 text-center'>
           <div className='p-[100px]'>
            ...
            <h2 className='font-normal mt-4 max-w-lg mx-auto text-[16px] text-zinc-400'>Create your own Data Recording dashboard and take over control over your data in real-time with E-dato software.</h2>
